"""
BACKUP REFERENCE: mercadopago_service.py de backend_legacy
================================================================================
Este archivo es una referencia del servicio de MercadoPago del backend legacy.
Contiene la lógica completa de integración con MercadoPago.

En el nuevo sistema (Vercel + Next.js), se puede usar la misma lógica traducida a TypeScript
o usar el SDK de MercadoPago para Node.js.
