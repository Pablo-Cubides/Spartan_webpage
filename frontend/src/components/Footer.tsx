      ...
      <div className="grid grid-cols-1 gap-8 px-6 py-12 mx-auto text-white max-w-7xl md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2">
            ...
            <li><Link href="/nosotros" className="hover:text-[#C62828] transition text-sm">Nosotros</Link></li>
          </ul>
        </div>
        {/* Newsletter */}
        <div>
          <h3 className="uppercase text-[#C62828] text-xs font-bold mb-3 tracking-widest">Boletín Informativo</h3>
          <p className="text-[#ababab] text-sm mb-3">Recibe consejos sobre disciplina, masculinidad y mejora personal en tu email.</p>
