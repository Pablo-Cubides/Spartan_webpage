...
const FlagIcon = () => (
  <svg
    className="w-12 h-12 text-[#D32F2F]"
    fill="currentColor"
    viewBox="0 0 24 24"
  >
...
const ShieldIcon = () => (
  <svg
    ...
    viewBox="0 0 24 24"
  >
    <path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm7 10c0 4.52-2.98 8.69-7 9.93-4.02-1.24-7-5.41-7-9.93V6.3l7-3.11 7 3.11V11zm-11.59.59L6 13l4 4 8-8-1.41-1.41L10 14.17z" />
  </svg>
);
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-20">
          ...
          <section className="py-10 md:py-16">
            <div className="relative overflow-hidden bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] rounded-3xl p-10 md:p-16 text-center border border-gray-800 shadow-2xl">
              <div className="absolute inset-0 bg-[url('/Hero.webp')] bg-cover bg-center opacity-5" />
