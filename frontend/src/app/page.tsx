            ...
            <div className="flex flex-col md:flex-row items-center gap-16">
              <div className="w-full md:w-1/2">
                ...
                <div className="space-y-6 text-gray-400 leading-relaxed text-lg">
                  <p>En Spartan Club, creemos que todo hombre posee un potencial ilimitado. Nuestra misión es proporcionarte el conocimiento, las herramientas y la comunidad para superar tus límites.</p>
              ...
              <div className="w-full md:w-1/2 flex justify-center">
                <div className="relative w-full max-w-md aspect-square rounded-lg overflow-hidden shadow-2xl">
                  <Image src="/Logo spartan club.png" alt="Spartan" fill style={{ objectFit: 'contain' }} sizes="(max-width: 768px) 100vw, 50vw" />
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="arsenal" className="relative py-32 flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none">
            <div className="w-full max-w-7xl mx-auto overflow-hidden rounded-md">
              <Image src="/Herramientas/Hero_herramientas_spartan.jpg" alt="Arsenal" fill style={{ objectFit: 'cover' }} sizes="100vw" />
            </div>
          ...
          <div className="relative z-30 container mx-auto px-6 text-center">
            <div className="max-w-3xl mx-auto border border-spartan-red/30 bg-black/40 backdrop-blur-sm p-12 rounded-sm relative">
              ...
              <Link href="/herramientas" className="bg-spartan-red hover:bg-red-600 text-white font-display font-bold py-3 px-8 rounded-sm tracking-widest uppercase transition-all shadow-lg hover:shadow-red-900/50">Explora las Herramientas</Link>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6">
            <div className="bg-[#1f1f1f] rounded-lg p-8 md:p-12 max-w-4xl mx-auto border border-gray-800 shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-gray-400 mb-8 max-w-2xl mx-auto">Recibe estrategias semanales, inspiración y contenido exclusivo directamente en tu correo. Sin spam, solo valor.</p>
                <NewsletterForm />
              </div>
            </div>
          </div>
