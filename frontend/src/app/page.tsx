  ...
  return (
    <div className="bg-spartan-dark text-spartan-text font-sans selection:bg-spartan-red selection:text-white">
      <main>
        ...
        <section
          id="hero"
          className="relative w-full flex items-center justify-center overflow-visible md:min-h-[60vh] min-h-[420px] py-12"
        >
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
            ...
            <p className="font-sans text-lg md:text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              ...
              destinado a ser: fuerte, disciplinado y con un propósito
              inquebrantable.
            </p>
            ...
            <div className="flex flex-col md:flex-row items-center gap-16">
              <div className="w-full md:w-1/2">
                ...
                <div className="space-y-6 text-gray-400 leading-relaxed text-lg">
                  ...
                  <p>
                    Te guiamos en el camino hacia la excelencia física, mental y
                    espiritual, basándonos en los principios atemporales de
                    disciplina, honor y resiliencia.
                  </p>
                </div>
              </div>
        ...
        >
          <div className="container mx-auto px-6 relative z-10">
            <div className="text-center mb-16">
              <h2 className="font-display text-4xl font-bold text-white uppercase tracking-wide inline-block relative pb-2">
                Artículos Destacados
              </h2>
              <p className="mt-4 text-gray-400">
                Conocimiento y estrategias para tu arsenal de crecimiento
                personal.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {posts.map((p) => (
                ...
                >
                  ...
                  <div className="p-6">
                    <h3 className="font-display text-xl font-bold text-white uppercase mb-3 leading-snug min-h-[3.5rem]">
                      {p.title}
                    </h3>
          ...
          <div className="relative z-30 container mx-auto px-6 text-center">
            <div className="max-w-3xl mx-auto border border-spartan-red/30 bg-black/40 backdrop-blur-sm p-12 rounded-sm relative">
              ...
              <p className="text-gray-300 text-lg mb-10 leading-relaxed">
                Accede a nuestra colección de recursos exclusivos diseñados para
                acelerar tu progreso y ayudarte a conquistar tus objetivos.
              </p>
              <Link
                href="/herramientas"
