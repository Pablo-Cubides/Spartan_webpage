// Coach Espartano - Profile API
// Handles Spartan Profile CRUD and onboarding
...
const getHandler = async (request: NextRequest) => {
    ...
    return NextResponse.json({
        hasProfile: !!user.spartanProfile?.onboardingDone,
        profile: user.spartanProfile ? {
            mainGoal: user.spartanProfile.mainGoal,
            subGoals: user.spartanProfile.subGoals,
            levels: user.spartanProfile.levels,
            currentFocuses: user.spartanProfile.currentFocuses,
            enabledCoaches: user.spartanProfile.enabledCoaches,
            conversations: user.spartanProfile.conversations
        } : null
    });
};
...
const postHandler = async (request: NextRequest) => {
    ...
    const profile = await prisma.spartanProfile.upsert({
