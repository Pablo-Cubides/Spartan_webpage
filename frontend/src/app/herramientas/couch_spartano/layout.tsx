...
export const metadata: Metadata = {
    ...
    description: '5 coaches especializados con inteligencia artificial para transformación masculina completa: Cuerpo, Estilo, Mentalidad, Productividad. Coaching personalizado 24/7, gratis para empezar.',
    keywords: [
        'coach espartano',
    ...
    openGraph: {
        title: 'Coach Espartano | Coaching con IA para Hombres',
        description: '5 coaches especializados: Cuerpo, Estilo, Mentalidad, Productividad. Transformación masculina con IA.',
        type: 'website',
        url: `${BASE_URL}/herramientas/couch_spartano`,
        images: [
            {
                url: `${BASE_URL}/og-coach-espartano.jpg`,
                width: 1200,
                height: 630,
                alt: 'Coach Espartano - Coaching con IA'
            }
        ],
    ...
    twitter: {
        ...
        title: 'Coach Espartano | Coaching con IA',
        description: '5 coaches especializados para transformación masculina completa',
        images: [`${BASE_URL}/og-coach-espartano.jpg`],
    },
    alternates: {
...
export default function CoachEspartanoLayout({ children }: { children: React.ReactNode }) {
    const jsonLd = {
        ...
        description: '5 coaches especializados con inteligencia artificial para transformación masculina: Cuerpo, Estilo, Mentalidad, Productividad y Coach General.',
        featureList: [
